...
url_nsfw = "https://api.comick.app/chapter/?lang=en&page=1&order=new&accept_mature_content=true"
url_sfw = "https://api.comick.app/chapter/?lang=en&page=1&order=new&accept_mature_content=false"

data_nsfw = requests.get(url_nsfw).json()
data_sfw = requests.get(url_sfw).json()

filename_nsfw = f"./comick/comick-rss-en-nsfw.xml"
filename_sfw = f"./comick/comick-rss-en-sfw.xml"
